		...
		<tbody> <!-- 장바구니 상품 출력 // 구매하기 진행시 보일부분 -->
			...
			<c:forEach var="dto" items="${sessionScope.dtos}">
				<tr>
					...
					<td>
						<a href="prodView.do?pnum=${dto.pnum}&pSpec=${dto.pspec}"> <!-- 클릭시 접속링크 -->
					...
					<td>
			    		<form action="checkoutDelete.do" method="post">
			...
			<tr>							<!-- name="checkForm"은 checkout.js파일에서 사용됌 -->
				<form action="checkoutDelete.do" name="checkForm" method="post">
